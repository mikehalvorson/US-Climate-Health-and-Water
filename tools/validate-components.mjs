...
if (shellStoryPages.length !== 8) failures.push(`Expected 8 gated story shells; found ${shellStoryPages.length}.`);
if (releasedStoryPages.length !== 6) failures.push(`Expected 6 released story chapters; found ${releasedStoryPages.length}.`);
